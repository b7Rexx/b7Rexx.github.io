...
if (app) {
  var boxObject = [
    ...
    {posX: 10, posY: 10, height: 50, width: 30,color: 'green', speed: 10},
    {posX: 10, posY: 10, height: 30, width: 50,color: 'green', speed: 25},
    {posX: 10, posY: 10, height: 15, width: 100,color: 'green', speed: 50},
